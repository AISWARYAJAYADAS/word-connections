...
class UserPreferences @Inject constructor(
    ...
    companion object {
        ...
        private val HAS_SEEN_INSTRUCTIONS = booleanPreferencesKey("has_seen_instructions")
    }
        ...
        val hasSeenInstructions = dataStore.data.map { preferences ->
            preferences[HAS_SEEN_INSTRUCTIONS] ?: false
        }
        ...
        suspend fun updateHasSeenInstructions(seen: Boolean) {
            dataStore.edit { preferences ->
                preferences[HAS_SEEN_INSTRUCTIONS] = seen
            }
        }
    }